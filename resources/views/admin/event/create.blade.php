...
<div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        ...
        @endif
        <h4 class="card-title"> Nouvel Evenement</h4>
        <form class="form-sample" method="POST" action="{{Route('event.store')}} " enctype="multipart/form-data">
            @csrf
            <p class="card-description"> Event info </p>
            <div class="row">
                <div class="col-md-6">
